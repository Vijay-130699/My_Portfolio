...
import { description, full_name, hello_labels, i_am_a_label, i_am_label, place } from '../../helpers/constants'
...
const Home = () => {
    ...
    const handleSlider = (position) => {
        ...
        setTimeout(() => {
            // Change content based on position after fade-out
            setChangeContent(position === 'left' ? false : true);
    ...
    return (
        <div id='home'>
            <div className={styles.container}>
                <div className={styles.name_container}>
                    ...
                    <label className={`${styles.job_title} ${!isFading ? styles.fade_in : styles.fade_out}`}>
                        {changeContent ? description : place}
                    </label>
                </div>
            ...
            <div className={styles.arrow_container}>
                <Left className={styles.arrow} onClick={() => handleSlider('left')} />
                <Right className={styles.arrow} onClick={() => handleSlider('right')} />
            </div>
        </div>
    )
}
